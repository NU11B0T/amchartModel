...
export default class BentGantt extends Component {

    componentDidMount(){        
    
        // cointainer to hold both charts
        var container = am4core.create("BentGantdiv", am4core.Container);
    ...
    render() {
        return (
            <div id="BentGantdiv" style={{ width: '40%', height: "400px"}}>
            </div>
        )
    }
}
